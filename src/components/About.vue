<template>
  <div>
    <div class="about-holder fade-component">
      ...
      <div class="content">
        <ul>
          <li v-for="item in activities" :key="item.id">{{ item }}</li>
        </ul>
      </div>
      ...
      <div class="content">
        <ul>
          <li v-for="item in contact" :key="item.id">{{ item }}</li>
        </ul>
      </div>
      ...
      <div class="content">
        <img src="/public/static/owl-logo.png">
      </div>
...
<script>
import activities from "../../public/static/activities.json";
import contact from "../../public/static/contact.json";
export default {
  name: "About",
  data() {
